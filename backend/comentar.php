...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Capturamos los datos forzando el tipo entero (int) para mayor seguridad
    $id_contenido = isset($_POST['id_contenido']) ? (int)$_POST['id_contenido'] : 0;
    $texto = isset($_POST['texto']) ? trim($_POST['texto']) : '';
    $id_usuario = (int)$_SESSION['id_usuario']; 

    // Validación rápida para evitar insertar campos vacíos
    ...
    // "iis" indica los tipos de datos: i = entero (id_contenido), i = entero (id_usuario), s = string (texto)
